 ...
 * Timestamp:                                          2024-09-25 14:52:37 GMT-05:00
 *
...
#ifndef SI5345_REVD_REG_CONFIG_HEADER_1
#define SI5345_REVD_REG_CONFIG_HEADER_1

#define SI5345_REVD_REG_CONFIG_NUM_REGS_1				526

#include "utils/datatypes.hpp"

/* NOTE: This file generated 9/25/2024
 * Input reference clock is set to 40 MHz (generated from lpgbt-fpga/clk40_o)
 * Spi_clk **1MHz** outputs:
 * This sets OUT4 to LVCMOS 2.5V with max impedance
 * It sets OUT8 to be LVCMOS 1.8V which can be sent back to the ZCU
 * 40MHz ref_clk output:
 * **disabled** to solve the scrambler deadlock issue.
 * 
 */
caribou::si5345_revb_register_t const si5345_revd_registers_1[SI5345_REVD_REG_CONFIG_NUM_REGS_1] =
{
 ...
 * Project File:       C:\Users\aquinn\OneDrive - Fermi National Accelerator Laboratory\Projects\SPROCKET\SP3A\SI5345 Projects\Si5345-RevD-SP3A-Project-40M-ref-spi-only.slabtimeproj
 * Design ID:          SP3A
 * Created By:         ClockBuilder Pro v4.13 [2024-05-31]
 * Timestamp:          2024-09-25 14:52:37 GMT-05:00
 * 
 ...
 * ============
 * 
 * Default CBPro Configuration for SPROCKET3A
 * 
 * Design Rule Check
 * =================
 * 
 ...
 * 
 * Warnings:
 * - OUT2 is disabled; consider setting to Unused to conserve power
 * - OUT4: For the best signal integrity, Skyworks strongly recommends selecting
 *   the lowest LVCMOS output impedance (24 ?) and then choosing the proper
 ...
 *    OUT1: Unused
 *    OUT2: 40 MHz
 *          Disabled, Custom 1.8 V, Low Power Differential, CM 0.8 V, AMPL 200 mVpp_se
 *    OUT3: Unused
 *    OUT4: 1 MHz
 *          Enabled, LVCMOS Comp 2.5 V 43 ?
 *    OUT5: Unused
 *    OUT6: Unused
 *    OUT7: Unused
 *    OUT8: 1 MHz
 *          Enabled, LVCMOS Comp 1.8 V 31 ?
 *    OUT9: Unused
 * 
 * Output Enable:
 *    OUT0: OE0
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  639 mW   639 mW   25 C  36 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 * VDDO0  OUT0       Unused        
 * VDDO1  OUT1       Unused        
 * VDDO2  OUT2       40 MHz  Custom Differential     1.80        9     16
 * VDDO3  OUT3       Unused        
 * VDDO4  OUT4        1 MHz  LVCMOS (comp)     2.50       13     33
 * VDDO5  OUT5       Unused        
 * VDDO6  OUT6       Unused        
 * VDDO7  OUT7       Unused        
 * VDDO8  OUT8        1 MHz  LVCMOS (comp)     1.80       13     24
 * VDDO9  OUT9       Unused        
 *                                   -------  -------  -----
 *                                      1.80      127    228
 *                                      2.50       13     33
 ...
 * Note:
 * 
 * - Tj is junction temperature. Tj must be less than 125 °C (on Si5345 Revision
 ...
 * 0x011D[7:6]   OUT4_CMOS_DRV               1                  0x1              
