...
namespace caribou {
  namespace carboard {
    ...
    //////////////////////////////////////////////////////////////////////////////
    //ZCU102 I2C Bus Addresses (determined by inspection of /sys/class/i2c-dev/)//
    //////////////////////////////////////////////////////////////////////////////


    //I2C bus for accessing Si570 USR MGT CLK (U56)
    // I2C1 0x74 Ch3
    const char* const BUS_I2C4 = "/dev/i2c-9";

    
    //CaR Board I2C 
    const char* const BUS_I2C0 = "/dev/i2c-15";
    const char* const BUS_I2C1 = "/dev/i2c-16";
    const char* const BUS_I2C2 = "/dev/i2c-17";
    const char* const BUS_I2C3 = "/dev/i2c-18";
    ...
    const i2c_reg_t REG_DAC_READ_INPUT_CHANNEL = 0x00; // Read DAC input register; last four bit indicate the channel number
    const i2c_reg_t REG_DAC_READ_CHANNEL = 0x10;       // Read DAC register; last four bit indicate the channel number
    const i2c_reg_t REG_DAC_READ_POWER = 0x40;         // Read power on/off DAC
    const i2c_reg_t REG_DAC_READ_CLEAR = 0x50;         // Read clear code reg
    const i2c_reg_t REG_DAC_READ_LDAC = 0x60;          // Read LDAC reg
    const i2c_reg_t REG_DAC_READ_MODE_STATIC = 0x80;   // Read internal reference (static mode)
    const i2c_reg_t REG_DAC_READ_MODE_FLEX = 0x90;     // Read internal reference (flexible mode)
