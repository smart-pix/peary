 ...
 * Created By:                                         ClockBuilder Pro v4.2 [2022-01-31]
 * Timestamp:                                          2022-02-11 23:04:45 GMT+01:00
 *
 ...
 * ========
 * Part:               Si5345AC Rev D
 * Project File:       D:\nextcloud\projects\dSiPM\ClockGenerator\Si5345-RevD-dsipm-Project.slabtimeproj
 * Design ID:          dsipm
 * Created By:         ClockBuilder Pro v4.2 [2022-01-31]
 * Timestamp:          2022-02-11 23:04:45 GMT+01:00
 *
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 408 MHz
 ...
 * Airflow:  2 m/s
 *
 * Total Power: 620 mW, On Chip Power: 614 mW, Tj: 36 °C
 *
 *         Frequency  Format   Voltage   Current     Power
 *         ---------  ------  --------  --------  --------
 * VDD                           1.8 V  109.7 mA    197 mW
 ...
 * VDDO6      Unused
 * VDDO7      Unused
 * VDDO8     408 MHz  LVDS       2.5 V   16.8 mA     42 mW
 * VDDO9      Unused
 *                                      --------  --------
 *                               Total  241.7 mA    620 mW
 *
 * Note:
 *
 * -Tj is junction temperature. Tj must be less than 125 °C (on Si5345 Revision D) for device to comply with datasheet
 * specifications. Tj = Ta + Theta_JA*On_Chip_Power. -Overall power includes on-chip power dissipation and adds differential
 * load power dissipation to estimate total power requirements. -Above are estimates only: power and temperature should be
 * measured on your PCB. -Selection of appropriate Theta-JA is required for most accurate estimate. Ideally, select 'User
 * Specified Theta-JA' and enter a Theta-JA value based on the thermal properties of your PCB.
 *
 * Settings
 * ========
 *
 ...
 * 0x0036[15:0]  LOS0_CLR_THR                70                 0x0046
 * 0x0038[15:0]  LOS1_CLR_THR                0                  0x0000
 * 0x003A[15:0]  LOS2_CLR_THR                70                 0x0046
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        12722              0x000031B2
 ...
 * 0x0235[43:0]  MXAXB_NUM                   620622774272       0x09080000000
 ...
 * 0x026C[7:0]   DESIGN_ID1                  115                0x73
 ...
 * 0x0302[43:0]  N0_NUM                      36507222016        0x00880000000
 ...
 * 0x0515[55:0]  M_NUM                       3723736645632      0x00036300000000
 ...
 * 0x0532[23:0]  HOLD_15M_CYC_COUNT          1042               0x000412
